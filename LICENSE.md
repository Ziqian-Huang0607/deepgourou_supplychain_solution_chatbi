...
They belong to the repository owners and sole copyright holders ("Owners": Ziqian-Huang0607, 
Team DeepGourou). These files are NOT open source. **ALL RIGHTS RESERVED**. 

Ownership
---------
This software, including all source code, assets, documentation, and
associated files (“Software”), is the exclusive property of the Owners. 
...
original source "willuhd/HKU-AI-Challenge", with no intent of the Prohibited Actions, 
